...
IMAGES.each do |image|
  namespace image.to_sym do |_args|
    ...
    task lint: :docker do
      ...
      # Ignore the need to pin apk package versions
      sh "docker run --rm -i hadolint/hadolint hadolint --ignore DL3008 --ignore DL3018 --ignore DL4000 --ignore DL4001 - < #{image}/Dockerfile"
    end
